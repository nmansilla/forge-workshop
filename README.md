...
To setup Docker and Node.js, follow the instructions in [A.SetupDocketAndNode.md](/A.SetupDocketAndNode.md).


## Setup the Forge CLI

To setup the Forge CLI, follow the instructions in [B.SetupTheForgeCLI.md](/B.SetupTheForgeCLI.md).
